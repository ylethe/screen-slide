    ...
    var PageSwitch = (function () {
        ...
        PageSwitch.prototype = {
            init : function () {
                ...
                me.index = (me.settings.index >= 0 && me.settings.index < me.pagesCount)?me.settings.instance :0;
                me.canScroll = true;
            ...
            _initEvent : function () {
                ...
                if(_prefix){
                    me.sections.on("transition webkitTransitionEnd oTransitionEnd otranstionend", function () {
                        me.canScroll = true;
